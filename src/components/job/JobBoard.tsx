...
const JOBS: JobCard[] = [
  ...
  },
  {
    ...
    shillScript:
      "We are hiring at $JOB. Requirements: wallet. Salary: payroll hourly. Benefits: vibes + gains. No experience necessary. Apply by buying $JOB.",
  },
  {
    id: 5,
    title: "Community Guy",
  ...
  },
  {
    ...
    shillScript:
      "just deployed a bot that monitors $JOB payroll and tweets hourly. unemployed by ChatGPT, rehired by $JOB. the irony is not lost on me.",
  },
  {
    id: 8,
    title: "Diamond Hands",
